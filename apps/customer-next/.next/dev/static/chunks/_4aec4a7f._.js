...
function getCart(tableToken) {
    ...
    ;
    try {
        return JSON.parse(localStorage.getItem(keyFor(tableToken)) || '[]');
    } catch  {
        return [];
    }
}
...
function MenuPage() {
    ...
    const [cartPreview, setCartPreview] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [animateCount, setAnimateCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MenuPage.useEffect": ()=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["customerApi"].menu(tableToken).then({
                "MenuPage.useEffect": (r)=>{
            ...
            }["MenuPage.useEffect"]).catch({
                "MenuPage.useEffect": (e)=>{
                    if (e instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ApiError"] && (e.status === 404 || e.status === 410)) {
            ...
            }["MenuPage.useEffect"]).finally({
                "MenuPage.useEffect": ()=>setLoading(false)
            }["MenuPage.useEffect"]);
        }
    }["MenuPage.useEffect"], [
        tableToken
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MenuPage.useEffect": ()=>{
            ...
            const cart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cart$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCart"])(tableToken);
            setCartCount(cart.reduce({
                "MenuPage.useEffect": (a, b)=>a + b.qty
            }["MenuPage.useEffect"], 0));
            setCartTotal(cart.reduce({
                "MenuPage.useEffect": (a, b)=>a + b.qty * b.price
            }["MenuPage.useEffect"], 0));
            setCartPreview(cart.slice(0, 3).map({
                "MenuPage.useEffect": (x)=>({
                        name: x.name,
                        qty: x.qty
                    })
            }["MenuPage.useEffect"]));
    ...
    const categories = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MenuPage.useMemo[categories]": ()=>{
            const set = new Set([
                'All'
            ]);
            products.forEach({
                "MenuPage.useMemo[categories]": (p)=>set.add(p.jenis_menu)
            }["MenuPage.useMemo[categories]"]);
    ...
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MenuPage.useMemo[filtered]": ()=>{
            const k = q.toLowerCase();
            return products.filter({
                "MenuPage.useMemo[filtered]": (p)=>{
    ...
    function handleAddToCart(p) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cart$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addToCart"])(tableToken, {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: [
                                    ...
                                    p.stok,
                                    " | Harga: ",
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$money$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatRupiah"])(Number(p.harga))
                                ]
                            }, void 0, true, {
                                fileName: "[project]/app/menu/page.tsx",
                                lineNumber: 118,
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$money$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatRupiah"])(cartTotal)
                            }, void 0, false, {
                                fileName: "[project]/app/menu/page.tsx",
                                lineNumber: 137,
                                columnNumber: 13
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: cartPreview.map((p, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(MenuPage, "AFQ4vrjAidthcmkcJXVlckJ8z8M=", false, function() {
    return [
...
//# sourceMappingURL=_4aec4a7f._.js.map